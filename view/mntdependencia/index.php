...
$rol = new Rol();
$datos = $rol->validar_menu_x_rol($_SESSION["rol_id"], "mntdependencia"); // <— slug de menú para DEPENDENCIA
...
<html lang="es">
  ...
  <body>
            ...
            <div class="row">
              <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                  <h4 class="mb-sm-0 font-size-18">Mantenimiento de Dependencia</h4>
                ...
                <div class="col-lg-12">
                  <div class="card">
                    <div class="card-header">
                      <h4 class="card-title">Dependencia</h4>
    ...
    <?php require_once("mnt.php")?> <!-- modal de mantenimiento -->

    <?php require_once("../html/sidebar.php")?>
    <div class="rightbar-overlay"></div>

    <?php require_once("../html/js.php")?>
    <script type="text/javascript" src="mntdependencia.js"></script> <!-- js específico -->
  </body>
</html>
<?php
} else {

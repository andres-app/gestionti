...
$rol = new Rol();
$datos = $rol->validar_menu_x_rol($_SESSION["rol_id"], "mntunidad"); // <— slug de menú para UNIDAD
...
<html lang="es">
  ...
  <body>
            ...
            <div class="row">
              <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                  <h4 class="mb-sm-0 font-size-18">Mantenimiento de Unidad Organica</h4>
    ...
    <script type="text/javascript" src="mntunidad.js"></script> <!-- igual que mntarea.js pero para unidad -->
  </body>
</html>
<?php
} else {
